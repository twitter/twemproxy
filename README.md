...
+ **command**: A list of extra commands, in format of 'command [key_step] [flag1|flag2]', that can be proxyed to redis servers to support customized commands from redis 4.0 modules.
