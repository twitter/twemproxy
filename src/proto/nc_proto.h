...
void memcache_parse_req(struct server_pool *sp, struct msg *r);
void memcache_parse_rsp(struct server_pool *sp, struct msg *r);
...
void redis_parse_req(struct server_pool *sp, struct msg *r);
void redis_parse_rsp(struct server_pool *sp, struct msg *r);
